    ...
    expect(parse(text)).toEqual({
      ...
      transactions: [
        ...
        },
        {
          ...
          amount: '-95.98',
          '_4:': 'FR18ZZZ531471',
          creditor_name: 'SOSH PRO',
          creditor_id: 'FR18ZZZ531471',
          creditor_id_type: '',
          remittance_information_1: 'FACTURE SOSHPRO 02/04/2023 F202304025208',
    ...
    expect(parse(text)).toEqual({
      ...
      transactions: [
        ...
        },
        {
          ...
          amount: '-11.98',
          '_4:': 'FR91ZZZ450973',
          creditor_name: 'AMENSAS',
          creditor_id: 'FR91ZZZ450973',
          creditor_id_type: '',
          remittance_information_1: 'PAYMENT ORDER 178674317',
          end2end_identification: 'KP53665-AMENORDER 178674317',
          purpose: '',
          mandate_identification: 'KP78745-AMENFR-1                   ',
          sequence_type: 'RCUR',
        },
        {
          record_code: '04',
          ...
          creditor_id: 'FR18ZZZ531471',
          creditor_id_type: '',
          remittance_information_1: 'FACTURE SOSHPRO 02/04/2023 F202304007806',
        ...
        },
        {
          ...
          creditor_id: 'FR16ZYZ012545',
          creditor_id_type: '',
          remittance_information_1:
            'VOTRE ABONNEMENT FIBRE (FACTURE  XXXXX3963C4) - P',
          end2end_identification: '1B966E396 C765D3864C574F',
          purpose: '',
          mandate_identification: 'M0063144755                        ',
          sequence_type: 'RCUR',
        },
      ],
      problems: [
      ...
      transactions: [
        {
          ...
          NOM: 'SAS  TACOS                         O Reilly IT',
          creditor_name: 'O Reilly IT',
          debtor_name: 'SAS  TACOS',
      ...
      transactions: [
        {
          ...
          label_1: '/INV/F4813768/0086247287 //2023',
          nb_of_dec: '2',
          operation_code: 'B1',
